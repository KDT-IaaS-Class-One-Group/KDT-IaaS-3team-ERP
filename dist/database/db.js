...
function query(sql, params) {
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, pool.execute(sql, params)];
                case 1:
                    rows = (_a.sent())[0];
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 3, , 4]);
                    return [4 /*yield*/, query('SELECT * FROM userInfo WHERE id = ?', [id])];
                case 1:
                    ...
                    return [4 /*yield*/, query(sql, [id, password, name])];
                case 2:
                    _a.sent();
                    return [2 /*return*/, { success: true }];
                case 3:
                    error_1 = _a.sent();
                    console.error('Error adding user:', error_1.message);
